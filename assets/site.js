...
(function () {
  ...
  function buildNavHTML(cur) {
    ...
    return [
      ...
      '</a>',
      '<div class="links">',
      '  <a class="nav-link'+cc('home')+'" href="/" data-key="home">首頁</a>',
      '  <div class="nav-item">',
      '    <a class="nav-link'+(aboutOn?' current':'')+'" href="/about-us/" data-key="about">關於我們<span class="nav-caret"></span></a>',
      '    <div class="dropdown">',
      '      <a class="ddi'+ddc('excellence')+'" data-d="excellence" href="/history/">卓越歷程</a>',
      '      <a class="ddi'+ddc('about')+'" data-d="about" href="/about-us/">關於我們</a>',
      '      <a class="ddi'+ddc('technicians')+'" data-d="technicians" href="/technicians/">卓越技師</a>',
      '      <a class="ddi'+ddc('quality')+'" data-d="quality" href="/quality/">關於修復品質</a>',
      '      <a class="ddi'+ddc('pricing')+'" data-d="pricing" href="/price-2/">參考價目與預約流程</a>',
      '    </div>',
      '  </div>',
      '  <div class="nav-item">',
      '    <a class="nav-link'+(svcOn?' current':'')+'" href="/pdr/" data-key="services">服務項目<span class="nav-caret"></span></a>',
      '    <div class="dropdown">',
      '      <a class="ddi'+ddc('svc-pdr')+'" data-d="svc-pdr" href="/pdr/">PDR凹痕修復</a>',
      '      <a class="ddi'+ddc('svc-ev')+'" data-d="svc-ev" href="/electriccar/">電動車凹痕修復</a>',
      '      <a class="ddi'+ddc('svc-large')+'" data-d="svc-large" href="/bigdent/">大面積凹痕修復</a>',
      '      <a class="ddi'+ddc('svc-alloy')+'" data-d="svc-alloy" href="/aluminum/">鋁合金凹痕修復</a>',
      '      <a class="ddi'+ddc('svc-moto')+'" data-d="svc-moto" href="/motortank/">重機油箱凹痕修復</a>',
      '    </div>',
      '  </div>',
      '  <a class="nav-link'+cc('blog')+'" href="/blog/" data-key="studio">工作日誌</a>',
      '  <a class="nav-link'+cc('case-video')+'" href="/case-video/" data-key="case">案例實績</a>',
      '  <div class="nav-item">',
      '    <a class="nav-link'+(trainOn?' current':'')+' " href="/news-3/" data-key="training">技術教學<span class="nav-caret"></span></a>',
      '    <div class="dropdown">',
      '      <a class="ddi'+ddc('training')+'" data-d="training" href="/news-3/">學習PDR</a>',
      '      <a class="ddi" href="https://www.denttrainer.com/courses/pdr-pdr-101-course" target="_blank" rel="noopener">PDR線上教學</a>',
      '      <a class="ddi'+ddc('training-2w')+'" data-d="training-2w" href="/training-2week/">中階技術訓練 <small style="opacity:.6;font-size:11px">2 Week</small></a>',
      '      <a class="ddi'+ddc('training-4w')+'" data-d="training-4w" href="/training-4week/">完整技術訓練 <small style="opacity:.6;font-size:11px">4 Week</small></a>',
  ...
  ready(function () {
    ...
    mobNavEl.innerHTML = [
      '<div class="mob-group"><a href="/">首頁</a></div>',
      '<div class="mob-group">',
      '  <div class="mob-toggle">關於我們<span class="nav-caret"></span></div>',
      '  <div class="mob-sub">',
      '    <a href="/history/">卓越歷程</a>',
      '    <a href="/about-us/">關於我們</a>',
      '    <a href="/technicians/">卓越技師</a>',
      '    <a href="/quality/">關於修復品質</a>',
      '    <a href="/price-2/">參考價目與預約流程</a>',
      '  </div>',
      '</div>',
      '<div class="mob-group">',
      '  <div class="mob-toggle">服務項目<span class="nav-caret"></span></div>',
      '  <div class="mob-sub">',
      '    <a href="/pdr/">PDR凹痕修復</a>',
      '    <a href="/electriccar/">電動車凹痕修復</a>',
      '    <a href="/bigdent/">大面積凹痕修復</a>',
      '    <a href="/aluminum/">鋁合金凹痕修復</a>',
      '    <a href="/motortank/">重機油箱凹痕修復</a>',
      '  </div>',
      '</div>',
      '<div class="mob-group"><a href="/blog/">工作日誌</a></div>',
      '<div class="mob-group"><a href="/case-video/">案例實績</a></div>',
      '<div class="mob-group">',
      '  <div class="mob-toggle">技術教學<span class="nav-caret"></span></div>',
      '  <div class="mob-sub">',
      '    <a href="/news-3/">學習PDR</a>',
      '    <a href="https://www.denttrainer.com/courses/pdr-pdr-101-course" target="_blank" rel="noopener">PDR線上教學</a>',
      '    <a href="/training-2week/">中階技術訓練 (2 Week)</a>',
      '    <a href="/training-4week/">完整技術訓練 (4 Week)</a>',
