...
(function () {
  ...
  function buildNavHTML(cur) {
    ...
    return [
      ...
      '      <a class="ddi'+ddc('pricing')+'" data-d="pricing" href="pricing.html">參考價目與預約流程</a>',
      ...
      '</div>',
      '<a class="cta" href="https://line.me/R/ti/p/%40pdr.tw" target="_blank" rel="noopener">',
      '  <span>LINE 預約</span>',
  ...
  ready(function () {
    ...
    mobNavEl.innerHTML = [
      ...
      '    <a href="pricing.html">參考價目與預約流程</a>',
      ...
      '  <a class="mob-cta" href="https://line.me/R/ti/p/%40pdr.tw" target="_blank" rel="noopener">',
      '    LINE 預約',
